...
#define MAX_SPEED 5000 // speed where my motor drew 3.6 amps at 12v.

ESC myESC (ESC_PIN, MIN_SPEED, MAX_SPEED, 500); // ESC_Name (PIN, Minimum Value, Maximum Value, Arm Value)
...
Serial.println(val);
myESC.speed(MAX_SPEED); // sets the ESC speed
